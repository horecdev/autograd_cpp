...
class Tensor {
    ...
    public:
        ...
        std::array<int64_t, sizeof...(args)> raw_coords = {static_cast<int64_t>(args)...}; 
        ...
        // when you do [expression(args)...] it means: apply expression to every arg, and seperate it with comas.
